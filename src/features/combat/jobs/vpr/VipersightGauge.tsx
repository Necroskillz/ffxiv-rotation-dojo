...
export const VipersightBar: FC<VipersightProps> = ({ active1, active2, fill1, fill2, fillColor1, fillColor2 }) => {
  return (
    <div className="grid grid-flow-col auto-cols-max">
      <div className={clsx(style.vipersight_bar, style.vipersight_bar_left, { [style.active1]: active1, [style.active2]: active2 })}>
        {fill1 && <div className={style.vipersight_bar_fill} style={{ background: fillColor1 }}></div>}
      </div>
      <div className={clsx(style.vipersight_bar, style.vipersight_bar_right, { [style.active1]: active1, [style.active2]: active2 })}>
...
export const VipersightGauge = () => {
  ...
  }, [combo, flanksbaneVenom, flankstungVenom, hindsbaneVenom, hindstungVenom, grimhuntersVenom, grimskinsVenom]);
